$(function() {
    ...
    var currentPatient = patients[Math.floor(Math.random() * patients.length)];
    var ailments = [
    ...
    var currentAilment = ailments[Math.floor(Math.random() * ailments.length)];
    ...
    var remedies = [
        ...
        { name: 'chickenpox_medicine', imageUrl: 'images/remedies/03_chickpox_medicine.png' },
    ...
    _.forEach(remedies, function(remedy) {
        $("#remedies").append($("<img>", { 'class': 'draggable remedy ' + remedy.name, 'src': remedy.imageUrl }));
    });
